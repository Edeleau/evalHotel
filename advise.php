...
<body>
    ...
    <div class="container-fluid window">
        <div class="row">
            ...
            <ul class="nav nav-pills mt-3 mb-3 col-12 col-xl-8 col-sm-10 col-md-8 col-ml-8 mx-auto justify-content-center" id="pills-tab" role="tablist">
            ...
            <div class="tab-content col-12 col-xl-8 col-sm-10 col-md-8 col-ml-8 mx-auto" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-chambre" role="tabpanel" aria-labelledby="pills-chambre-tab">
                    <div class='avis'>
                ...
                <div class="tab-pane fade" id="pills-soin" role="tabpanel" aria-labelledby="pills-soin-tab">
                    <div class='avis'>
            ...
            <form class="col-12 col-xl-8 col-sm-10 col-md-8 col-ml-8 mx-auto">
                <div class="form-group">
                    <textarea class="form-control" id="textArea" rows="6" require></textarea>
                </div>
                <div class="form-btn">
    ...
    include("./footer.php");
    ?>
    <script src="./assets/js/advise.js"></script>
</body>
